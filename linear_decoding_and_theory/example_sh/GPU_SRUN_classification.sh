...
script_string="path//to/CLUSTER_classification.py \\
--job_id $SLURM_JOB_ID \\
--layer backbone \\
...
#--random_projection_size 168 \\
#--random_projection_seed 2 \\
#--random_subsample_size 168 \\
#--random_subsample_seed 1 \\
#
# l2 regularization range: Select based on the dataset
# FOR SDXL DATASET
--l2_min_exp -10 \\
--l2_max_exp 2 \\
--n_l2 40 \\
# FOR REPRESENTATIONS DICARLO PUBLIC
#--l2_min_exp -12 \\
#--l2_max_exp -1 \\
#--n_l2 40 \\
#
...
# check --gres=gpu:<number> matches in srun and SBATCH
# check logfiles location
# make sure categories dictionary has been updated and loaded to cluster
