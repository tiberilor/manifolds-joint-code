...
def main():
    ...
    DATASET_DIR = "path/to/dataset"  # Dataset root containing category subdirectories with bboxes/.
    # The path below should always be the one in the train dataset!
    CATEGORY_MAPPING_PATH = "path/to/categories.pkl"  # Category-to-index mapping created by the categories script.
    IMG_SIZE = 512  # Image dimensions
    THREADS = 16
